 ...
 <h1>Purchase Order</h1>
            <s:iterator value="order">
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td><label id="nameFieldId">Material Id : </label></td>
                            <td><s:property value="productId"></s:property></td>
                            </tr>

                            <tr>
                                <td><label id="nameFieldId">Supplier Id : </label></td>
                                <td><s:property value="supplierId"></s:property></td>
                            </tr>

                            <tr>
                                <td><label id="nameFieldId">Quantity : </label></td>
                                <td><s:property value="quantity"></s:property></td>
                            </tr>

                            <tr>
                                <td><label id="nameFieldId">Unit Price : </label></td>
                                <td><s:property value="unitPrice"></s:property></td>
                            </tr>

                            <tr>
                                <td><label id="nameFieldId">Total Price : </label></td>
                                <td><s:property value="totalPrice"></s:property></td>
                            </tr>

                            <tr>
                                <td><label id="nameFieldId">Required Date : </label></td>
