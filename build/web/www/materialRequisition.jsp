            ...
            <div class="templatemo-content col-1 light-gray-bg">
                ...
                <div align="center">
                    <s:form action="newRequisition" method="post" name="requisition">
                        ...
                        <s:select label="Material Id" id="nameFieldId"
                                  list="{'1', '2', '3', '4', '5', '6'}" 
                                  name="materialId" 

                                  />
                        <s:select label="Material Name" id="nameFieldId"
                        ...
                        <s:textfield id="nameFieldId" type="text" name="requiredDate" label="Required Date" size="20"></s:textfield>
                        <s:select label="Production Line" id="nameFieldId"
                                  ...
                                  value="5" 
                                  />
                        <s:textfield id="nameFieldId" type="text" name="authorizedBy" label="Authorized Person" size="20"></s:textfield>
