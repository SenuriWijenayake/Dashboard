        ...
        <div class="templatemo-flex-row">
            ...
            <div class="templatemo-content col-1 light-gray-bg">
                ...
                <div class="templatemo-flex-row flex-content-row">
                    ...
                    <div>
                        <s:label type="text" value= "Manufacturing & Procurement Home" style="font-size: 20pt;"></s:label>
                        <br/><br/>
                        <table border="1" cellpadding="15" align="center" width="80%" height="80%">
                            <thead>
                                <tr>
                                    <th>Requisitions</th>
                                    <th>Procurements</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td> <a href="materialRequisition.jsp">
                                            Create New Procurement</td>
                                    <td> <a href="placePurchaseOrder.jsp">
                                            Place Purchase Order
                                        </a> </td>
                                </tr>
                                <tr>
                                    <td> <a href="viewExistingRequisitions.jsp">
                                            View Existing Procurements
                                        </a></td>
                                    <td>
                                ...
                                <tr>
                                    <td><a href="deleteRequisition.jsp">
                                            Delete Requisitions
                                        </a>
                                    <td>
